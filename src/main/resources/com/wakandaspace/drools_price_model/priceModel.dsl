...
[then]  Calculate the individual premium result = plan.setIndividualPremiumResult(benefit.getCalculationResult() * ((sumFinalFactor * search("Pre Authorization",plan.getPreAuthorizationRequired())) /getRatio(plan.getName()))*12);